...
@section('content')
    ...
    <div class="home-banner-area mb-4 pt-3" style="padding: 0 !important;">
                                ...
                                <div class="carousel-box">
                                    <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                        <img
                                            ...
                                            height="315"
                                            @endif
                                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';"  style="
    height: 82vh; 
"
                                        >
                                    </a>
            ...
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="d-flex flex-wrap mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-600 mb-0">
                        <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block" style="font-size: 26px;font-style: italic;color: #B57F2F;">{{ translate('Flash deals') }}</span>
                    </h3>
                    <div class="aiz-count-down ml-auto ml-lg-3 align-items-center" data-date="{{ date('Y/m/d H:i:s', $flash_deal->end_date) }}" style="--primary: #EB0000;"></div>
                    <a href="{{ route('flash-deal-details', $flash_deal->slug) }}" class="ml-auto mr-0 btn btn-primary btn-sm shadow-md w-100 w-md-auto" style="background-color: transparent;border-color:  #A57F2B;color: #A57F2B;font-style: italic;">{{ translate('View More') }}</a>
                </div>
                                ...
                                <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                    <div class="position-relative">
                                        ...
                                        <a href="javascript:void(0)" onclick="addToWishList({{ $product->id }})" data-toggle="tooltip" data-title="{{ translate('Add to wishlist') }}" data-placement="left">
                                                <!-- <i class="la la-heart-o" style="font-size: 4vh;
"  ></i> -->
                                            </a>
                                            <img
...
">{{  $product->getTranslation('name')  }}</a>
                                        ...
                                        <span class="fw-700 text-primary" style="color: #B57F2F !important;  font-size: 3vh;">{{ home_discounted_base_price($product->id) }}</span> <br>
                                            @if(home_base_price($product->id) != home_discounted_base_price($product->id))
                                        ...
                                        <div class="rating rating-sm mt-1">
                                            ...
                                            <a href="javascript:void(0)" onclick="showAddToCartModal({{ $product->id }})" data-toggle="tooltip" data-title="{{ translate('Buy Now') }}" data-placement="left">
                                            <button style="
